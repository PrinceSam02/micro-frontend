...
const Booking = () => {
    ...
    // Update totalGuests and numDays whenever numAdults, numChildren, checkInDate, or checkOutDate changes
    useEffect(() => {
        ...
        const numDays = checkInDate && checkOutDate && checkInDate < checkOutDate
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
            <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">Booking Form</h2>
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label htmlFor="checkInDate" className="block text-sm font-medium text-gray-700">Check-In Date</label>
                ...
                <div className="mb-4">
                    ...
                    <input
                        ...
                        name="aadharCard"
                        onChange={handleFileChange}
                        className="mt-1 block w-full text-sm text-gray-500 border border-gray-300 rounded-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500"
                        accept="image/*"
                        required
                    />
                </div>
